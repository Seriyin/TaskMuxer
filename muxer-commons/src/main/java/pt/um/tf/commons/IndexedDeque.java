 ...
 *
 * <p>Most {@code IndexedDeque} operations run in amortized constant time.
 * Exceptions include
 ...
 * @since   1.6
 */
public class IndexedDeque<E> extends AbstractCollection<E>
        implements Deque<E>, Cloneable, Serializable
{
    ...
    private class DescendingIterator implements Iterator<E> {
        ...
        DescendingIterator() { cursor = head; }
    ...
    public E get(int index) {
        return (E) elements[index < sub(head, tail, elements.length) ? inc(head, index, elements.length) : tail];
    }
